...
class HomeScreen(tk.Frame):
    ...
    def place_widgets(self):
        self.create_league_button.place(x=20, y=250)
        self.join_league_entry.place(x=20, y=150)
        self.join_league_button.place(x=20, y=200)
        self.join_league_text.place(x=20, y=100)
        ...
        for i in range(len(self.league_id)):
            self.league_id[i].place(x=400, y=100+i*50)
            self.league_name[i].place(x=500, y=100+i*50)
            self.start_gameweek[i].place(x=600, y=100+i*50)
